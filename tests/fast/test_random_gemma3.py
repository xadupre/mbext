...
from modelbuilder.ext_test_case import ExtTestCase, has_transformers, hide_stdout, requires_cuda, requires_genai, requires_transformers
...
class TestRandomGemma3(ExtTestCase):
    ...
    @hide_stdout()
    @requires_cuda()
    def test_fast_discrepancy_gemma3_int4_cuda(self):
        self.common_fast_gemma3_random_weights("int4", "cuda")
