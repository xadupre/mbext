...
from modelbuilder.ext_test_case import ExtTestCase, run_session_or_io_binding, hide_stdout, requires_cuda, requires_yobx
...
class TestMistralNeMo(ExtTestCase):
    ...
    @hide_stdout()
    def test_mistral_nemo_fp32_cpu_genai_generate(self):
        try:
        ...
        prefix = "test_mistral_nemo_fp32_cpu_genai_generate"
        num_hidden_layers = 1
        config = MistralConfig(
            architectures=["MistralNeMoForCausalLM"],
            bos_token_id=1,
