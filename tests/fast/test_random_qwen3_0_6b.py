...
class TestRandomQwen3(ExtTestCase):
    @hide_stdout()
    def test_qwen3_0_6b_fp32_cpu_random_weights(self):
        """
        Convert a model with the same architecture as Qwen/Qwen3-0.6B but with
        ...
        * The ONNX logits closely match those of the original PyTorch model.
        ...
        model_dir = self.get_model_dir("test_qwen3_0_6b_fp32_cpu_random_weights")
        output_dir, cache_dir = self.get_dirs("test_qwen3_0_6b_fp32_cpu_random_weights")
