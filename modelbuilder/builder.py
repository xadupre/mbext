...
def create_model(
    ...
    **extra_options,
    ...
    config = AutoConfig.from_pretrained(
        hf_name, token=hf_token, trust_remote_code=hf_remote, **extra_kwargs
    )
    ...
    if (
        config.architectures[0] == "ChatGLMForConditionalGeneration"
        or config.architectures[0] == "ChatGLMModel"
    ):
