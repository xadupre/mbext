...
class Qwen35TextModel(Model):
    ...
    def _make_synthetic_position_ids(self):
        ...
        self.make_slice(
            bs_shape_name,
            inputs=[f"{shape_name}/output_0", "/model/constants/INT64/[1]", "/model/constants/INT64/[3]", "/model/constants/INT64/[0]"],
        ...
        self.make_reshape(
            flat_name, inputs=[pos_ids_input, "/model/constants/INT64/[3, -1]"], dtype=ir.DataType.INT64, shape=[3, "batch_seq"]
        )
